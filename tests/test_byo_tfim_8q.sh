...
# Usage: source env.sh && sbatch test_byo_tfim_8q.sh
#SBATCH --job-name=hpcqc_byo_tfim_8q
...
#SBATCH --output=slurm_logs/byo_tfim_8q.o%j
#SBATCH --error=slurm_logs/byo_tfim_8q.e%j
...
export SINGULARITYENV_CONFIG_PATH="${HPCQC_ROOT}/configs/byo_tfim_8q.yaml"

SLURM_START_EPOCH=$(date +%s)
echo "=== lumi-hpc-qc: BYO TFIM 8q (SU2) ==="
