...
export HPCQC_SWEEP_CONFIG="${HPCQC_SWEEP_CONFIG:-examples/byo/floquet_dtc_q10_echo_sweep.yaml}"
export HPCQC_SWEEP_OUTDIR="${HPCQC_SWEEP_OUTDIR:-${HPCQC_ROOT}/results/autocorr_echo_12p_10qb_10s_40k_100s_${SLURM_JOB_ID:-local}}"
