#!/bin/bash
#SBATCH --job-name=autocorr_echo_200p_10qb_10s_40k_100s_sweep_multinode
...
#SBATCH --output=slurm_logs/autocorr_echo_200p_10qb_10s_40k_100s_sweep_multinode.o%j
#SBATCH --error=slurm_logs/autocorr_echo_200p_10qb_10s_40k_100s_sweep_multinode.e%j

source "${SLURM_SUBMIT_DIR:-$(cd "$(dirname "$0")" && pwd)}/env.sh"
export MPICH_OFI_NIC_POLICY=NUMA
export MPICH_GPU_SUPPORT_ENABLED=0
export HPCQC_SWEEP_CONFIG="${HPCQC_SWEEP_CONFIG:-examples/byo/floquet_dtc_200p_q10_spatial_survey_device_calibrated_100shots.yaml}"
export HPCQC_SWEEP_OUTDIR="${HPCQC_SWEEP_OUTDIR:-${HPCQC_ROOT}/results/autocorr_echo_200p_10qb_10s_40k_100s_spatial_survey${SLURM_JOB_ID:-local}}"
